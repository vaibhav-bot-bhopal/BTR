...
@section('title', 'BTR - Login System')
...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="logo text-center mt-3">
            <img src="{{asset('public/assets/images/bandhavgarh_logo.png')}}" alt="BTR-LOGO" width="80" height="80">
        </div>

        <div class="card-header text-center">
            <a href="{{ url('/') }}" class="h1" target="_blank"><b>B</b>TR</a>
        </div>
