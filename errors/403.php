<?php
define('BASE_URL', 'http://localhost/BTR/');
?>
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" <?php echo 'href="' . BASE_URL . 'public/assets/images/favicon.png"' ?>>
    <link rel="apple-touch-icon" <?php echo 'href="' . BASE_URL . 'public/assets/images/favicon.png"' ?>>
